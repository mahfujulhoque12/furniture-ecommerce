...
import { cardData } from "@/data/wallData";
...
const Wall:React.FC = () => {
    ...
    const handleDetails = (slug:string) => {
        router.push(`wall-art-mirrors/${slug}`)
    }
  ...
  return (
    <section className="py-5 md:py-10">
        ...
        <div>
            <h1 className="text-lg text-start  sm:text-start  md:text-2xl font-semibold text-black capitalize">Wall Art & Mirrors</h1>
