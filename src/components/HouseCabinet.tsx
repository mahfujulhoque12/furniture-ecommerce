...
const HouseCabinet = () =>{
    ...
    const cabinetData = cardData.filter((card)=> card.id >=21 && card.id <= 30)
    return(
        <section className="py-5 md:py-10">
            <MaxWidthWrapper>
            <div className="flex flex-col md:flex-row justify-between">
                <h1 className="text-lg text-center  sm:text-start md:text-2xl font-semibold text-black capitalize">House Cabinet</h1>
