...
const MagicHoliday = () => {
  return (
    ...
    <MaxWidthWrapper>
                ...
                <h1 className="text-lg md:text-2xl font-semibold text-black capitalize">holiday magic made affordable</h1>

    <div className="mt-6 grid grid-cols-2 sm:grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
        {cardData.map((card)=>(
                 <div className="cursor-pointer relative" key={card.id}>
                 <div className="transition transform duration-500 shadow-md hover:scale-[101%]">
                   <Image src={card.image} alt="img" width={400} height={600} className="h-[400px] object-cover rounded-md" />
