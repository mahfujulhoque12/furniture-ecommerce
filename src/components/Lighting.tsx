...
import { cardData } from "@/data/lightingData";
...
const Lighting:React.FC = () => {
    ...
    const handleDetails = (slug:string) => {
        router.push(`lighting-solutions/${slug}`)
    }
  ...
  return (
    <section className="py-5 md:py-10">
        ...
        <div>
            <h1 className="text-lg text-start  sm:text-start  md:text-2xl font-semibold text-black capitalize">Lighting Furniture</h1>
