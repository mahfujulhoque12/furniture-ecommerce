...
import { cardData } from "@/data/fabricData";
...
const Fabric:React.FC = () => {
    ...
    const handleDetails = (slug:string) => {
        router.push(`fabric-furniture/${slug}`)
    }
  ...
  return (
    <section className="py-5 md:py-10">
        ...
        <div>
            <h1 className="text-lg text-start  sm:text-start  md:text-2xl font-semibold text-black capitalize">Fabric Furniture</h1>
