...
import { cardData } from "@/data/tvData";
...
const TvUnits:React.FC = () => {
  ...
  return (
    <section className="py-5 md:py-10">
        ...
        <div>
            <h1 className="text-lg text-start  sm:text-start  md:text-2xl font-semibold text-black capitalize">TV Units & Media Stands</h1>
