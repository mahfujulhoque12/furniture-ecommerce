...
const OfficeWorkStation = () =>{
    ...
    const chairData = cardData.filter((card)=> card.id >=531 && card.id <= 540)
    return(
        <section className="py-5 md:py-10">
            <MaxWidthWrapper>
            <div className="flex flex-col md:flex-row justify-between">
                <h1 className="text-lg text-center  sm:text-start md:text-2xl font-semibold text-black capitalize">Office Work Station</h1>
