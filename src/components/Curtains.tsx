...
import { cardData } from "@/data/curtainsData";
...
const Curtains:React.FC = () => {
    ...
    const handleDetails = (slug:string) => {
        router.push(`curtains-blinds/${slug}`)
    }
  ...
  return (
    <section className="py-5 md:py-10">
        ...
        <div>
            <h1 className="text-lg text-start  sm:text-start  md:text-2xl font-semibold text-black capitalize">Curtains & Blinds</h1>
